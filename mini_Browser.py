...
class MainWindow(QtGui.QMainWindow):
    ...
    def initUI(self):
        ...
        loadFinished = self.progressbar.hide, loadStarted = self.progressbar.
        show,titleChanged = self.setWindowTitle)
        ...
        self.setting.setAttribute(QWebSettings.OfflineWebApplicationCacheEnabled, True)
        self.setting.setAttribute(QWebSettings.ZoomTextOnly, True)
        self.setting.setAttribute(QWebSettings.AcceleratedCompositingEnabled, True)
        ...
        self.setting.setAttribute(QWebSettings.LocalContentCanAccessFileUrls, True)        
